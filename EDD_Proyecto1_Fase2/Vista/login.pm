...
sub mostrar_login {
    my ($class, $arbol_usuarios, $lista_proveedores, $lista_medicamentos, $arbol_equipo, $arbol_suministros, $matriz_proveedores_fabricantes) = @_;
    ...
    $dialog->signal_connect(response => sub {
        ...
        if ($response eq 'accept') {
            ...
            if ($user_actual eq "admin" && $pass_actual eq "admin") {
                ...
                my $v_admin = admin->mostrar_admin($arbol_usuarios, $user_actual, $lista_proveedores, $lista_medicamentos, $arbol_equipo, $arbol_suministros, $matriz_proveedores_fabricantes);
