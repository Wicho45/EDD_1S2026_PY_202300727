...
sub mostrar_signin {
    my ($class, $arbol_usuarios, $parent) = @_;
    ...
    $dialog->signal_connect(response => sub {
        ...
        if ($response eq 'accept') {
            ...
            if($arbol_usuarios->buscar($username, $num_colegio)){
            ...
            my $departamento = obtener_departamento($departamento_actual);
            ...
            print "Usuario registrado: " . $nuevo_usuario->get_username() . "\n";
